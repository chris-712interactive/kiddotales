  ...
  "pages": [
    {
      ...
      "illustrationPromptBase": "Scene description ONLY: setting, action, lighting, and composition. Do NOT repeat character face or body traits. Do NOT describe the child's clothing, colors, or accessories—the wardrobe is fixed by illustrationOutfitLock only. Every person in the scene must remain fully modestly clothed (no bathing, undressing, or revealing outfits). CRITICAL when a unicorn or creature appears: phrase as 'a human child standing beside a unicorn' or 'a human child next to a fox'—NEVER 'princess with unicorn' or phrases that could blend child and creature. Example: 'A human child kneeling to examine a glowing mushroom circle in a misty forest clearing at sunrise, soft golden light through the trees'",
